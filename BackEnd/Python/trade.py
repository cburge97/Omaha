...
def main():
    ...
    print "The players you want to recieve from the other team has an averge overall score of ", add_score, "out of 5 stars \n"
    ...
    print "The players you want to trade away from your team has an averge overall score of ", drop_score, "out of 5 stars \n"
